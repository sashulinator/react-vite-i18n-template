...
import { DropdownItemProps, DropdownListItem } from '~/ui/dropdown-list/ui/item'
import { Key, ListProps, ListState } from '~/ui/list'
// import DropdownList from '~/ui/dropdown-list/ui/dropdown-list'
    ...
    <main className='pt-5rem'>
      ...
      >
        ...
        <div className='mt-1rem'>
          ...
          <Dropdown<TextInputProps, ListProps<User, DropdownItemProps<User>>>
            value={item?.username}
...
// function SingleSelectItem<TItemProps>(props: ItemProps<User, TItemProps>) {
